 ...
 *
 */
public class ChevalThatWorked extends Command {
    ...
    protected void execute() {
    	...
    	switch(step){
    		case 0: 
    			...
    			break;
    		case 1: /** UNTESTED **/
    			bigCommand = new DriveForDistanceBackward(-2.5 * DriveTrain2.TICKS_PER_FOOT, 0.75, 0.0);
    			bigCommand.start();
    			step++;
    			break;
    		case 2:
//    			L.og(bigCommand.isRunning());
    		...
    		case 7:
    			...
    			break;
    		case 8:
    			bigCommand = new DriveForDistanceBackward(-5.9 * DriveTrain2.TICKS_PER_FOOT, 0.4, 0.0);
    			bigCommand.start();
    			step++;
    			break;
    		case 9:
